  ...
  const experience = [
    {
      ...
      description: [
        ...
        "Implemented advanced animations using Framer Motion and Three.js",
    ...
    },
    {
      ...
      period: "2022 - 2023",
      description: [
        "Developed modern React applications with TypeScript",
    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4 text-center">Contact Information</h2>
              ...
              {experience.map((job, index) => (
                ...
                >
                  <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                    ...
                    <span className="text-gray-400 text-sm md:text-base">{job.period}</span>
                  </div>
